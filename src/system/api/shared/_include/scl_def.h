...
#define _SYSCALL_REMOVE_PAR { _stackPtr += 20; }

#define SYSCALL_CALL(INT_CODE, CODE, PAR1, PAR2, PAR3, PAR4) {\
    _SYSCALL_PUSH_PAR(PAR4);                                  \
    ...
    _SYSCALL_REMOVE_PAR;                                      \
} __attribute__((unused)) addr_t * _resultPtr = (addr_t *)(_stackPtr - 20);
