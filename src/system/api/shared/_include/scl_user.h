...
#define SYSCALL_USER_FUNCTION_DEV_INIT                      0x17
#define SYSCALL_USER_FUNCTION_DEV_START                     0x18
#define SYSCALL_USER_FUNCTION_DEV_GET_COUNT_FOR_OPERATOR    0x19
#define SYSCALL_USER_FUNCTION_DEV_GET_IDS_FOR_OPERATOR      0x1a
#define SYSCALL_USER_FUNCTION_WAIT_FOR_PROC                 0x1b

#define SYSCALL_USER_CALL(CODE, PAR1, PAR2, PAR3, PAR4) \
SYSCALL_CALL(SYSCALL_USER_INTERRUPT, SYSCALL_USER_FUNCTION_ ## CODE, PAR1, PAR2, PAR3, PAR4)
