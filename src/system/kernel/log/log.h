...
#define LOG4(MSG1, MSG2, MSG3, MSG4)                LOG_BLOCK(LOG_NBR(MSG1); LOG_NBR(MSG2); LOG_NBR(MSG3); LOG_NBR(MSG4);)
#define LOG5(MSG1, MSG2, MSG3, MSG4, MSG5)          LOG_BLOCK(LOG_NBR(MSG1); LOG_NBR(MSG2); LOG_NBR(MSG3); LOG_NBR(MSG4); LOG_NBR(MSG5);)
#define LOG6(MSG1, MSG2, MSG3, MSG4, MSG5, MSG6)    LOG_BLOCK(LOG_NBR(MSG1); LOG_NBR(MSG2); LOG_NBR(MSG3); LOG_NBR(MSG4); LOG_NBR(MSG5); LOG_NBR(MSG6);)
