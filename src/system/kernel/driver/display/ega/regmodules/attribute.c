...
void attributeSetMode(const enum modeOfOperation mode, const bool memOver64K) {
    ...
    case CD_OPMODE_3: {
        ...
        reg.palette[0x2]     = 0x02;
        reg.palette[0x3]     = 0x03;
        reg.palette[0x4]     = 0x04;
        reg.palette[0x5]     = 0x05;
        reg.palette[0x6]     = 0x06;
        reg.palette[0x7]     = 0x07;
        reg.palette[0x8]     = 0x10;
        reg.palette[0x9]     = 0x11;
        reg.palette[0xA]     = 0x12;
        reg.palette[0xB]     = 0x13;
        reg.palette[0xC]     = 0x14;
        reg.palette[0xD]     = 0x15;
        reg.palette[0xE]     = 0x16;
        reg.palette[0xF]     = 0x17;
        reg.modeControl      = 0x08;
        reg.colorPlaneEnable = 0x0F;
    } break; 
    case CD_OPMODE_4:
    case CD_OPMODE_5: {
        reg.palette[0x1]     = 0x13;
        reg.palette[0x2]     = 0x15;
        reg.palette[0x3]     = 0x17;
        reg.palette[0x4]     = 0x02;
        reg.palette[0x5]     = 0x04;
        reg.palette[0x6]     = 0x06;
        reg.palette[0x7]     = 0x07;
        reg.palette[0x8]     = 0x10;
        reg.palette[0x9]     = 0x11;
    ...
    case CD_OPMODE_6: {
        reg.palette[0x1]     = 0x17;
        reg.palette[0x2]     = 0x17;
        reg.palette[0x3]     = 0x17;
        reg.palette[0x4]     = 0x17;
        reg.palette[0x5]     = 0x17;
        reg.palette[0x6]     = 0x17;
        reg.palette[0x7]     = 0x17;
        reg.palette[0x8]     = 0x17;
        reg.palette[0x9]     = 0x17;
        reg.palette[0xA]     = 0x17;
        reg.palette[0xB]     = 0x17;
        reg.palette[0xC]     = 0x17;
        reg.palette[0xD]     = 0x17;
        reg.palette[0xE]     = 0x17;
        reg.palette[0xF]     = 0x18;
        reg.modeControl      = 0x01;
    ...
    case MD_OPMODE_7: {
        reg.palette[0x1]     = 0x08;
        reg.palette[0x2]     = 0x08;
        reg.palette[0x3]     = 0x08;
        reg.palette[0x4]     = 0x08;
        reg.palette[0x5]     = 0x08;
        reg.palette[0x6]     = 0x08;
        reg.palette[0x7]     = 0x08;
        reg.palette[0x8]     = 0x10;
        reg.palette[0x9]     = 0x18;
        reg.palette[0xA]     = 0x18;
        reg.palette[0xB]     = 0x18;
        reg.palette[0xC]     = 0x18;
        reg.palette[0xD]     = 0x18;
        reg.palette[0xE]     = 0x18;
        reg.palette[0xF]     = 0x17;
    ...
    case MD_OPMODE_F: {
        ...
        reg.palette[0x4]     = 0x18;
        reg.palette[0x5]     = 0x18;
        reg.palette[0x6]     = 0x00;
        reg.palette[0x7]     = 0x00;
        reg.palette[0x8]     = 0x00;
        reg.palette[0x9]     = 0x08;
    ...
    case ECD_OPMODE_3: {
        ...
        reg.palette[0x4]     = 0x04;
        reg.palette[0x5]     = 0x05;
        reg.palette[0x6]     = 0x14;
        reg.palette[0x7]     = 0x07;
        reg.palette[0x8]     = 0x38;
        reg.palette[0x9]     = 0x39;
        reg.palette[0xA]     = 0x3A;
        reg.palette[0xB]     = 0x3B;
        reg.palette[0xC]     = 0x3C;
        reg.palette[0xD]     = 0x3D;
        reg.palette[0xE]     = 0x3E;
        reg.palette[0xF]     = 0x3F;
        reg.modeControl      = 0x08;
        reg.colorPlaneEnable = 0x0F;
    } break;
    case ECD_OPMODE_10: {
